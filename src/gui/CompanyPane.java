...
public class CompanyPane extends GridPane {
    ...
    public CompanyPane() {
        ...
        // Tilføjer Customer TextField Area
        ...
        btnCustomer.setOnAction(event -> this.createCustomerAction());
    ...
    private void createCustomerAction() {
        ...
        CustomerWindow dialog = new CustomerWindow("Create Customer", company);
        dialog.showAndWait();
    ...
    public void updateControls() {
        ...
        if (company != null) {
            ...
            for (Customer cus : company.getCustomers()) {
                customerString.append(cus).append("\n");
            }
            txaCustomers.setText(customerString.toString());
